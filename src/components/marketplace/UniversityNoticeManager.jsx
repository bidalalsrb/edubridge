    ...
    <div className="mt-5 space-y-5">
      <Card className="border-[#d7dfea]">
        ...
        <CardContent className="grid gap-3 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3">
            <p className="text-xs font-bold text-[#336fea]">예산/마감일</p>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3 md:col-span-2">
            <p className="text-xs font-bold text-[#336fea]">요청 상세</p>
      ...
      {directTarget ? (
        <Card className="border-[#336fea] bg-[#eef4ff]">
      ...
      <Card className="border-[#d7dfea]">
        ...
        <CardContent>
          <div className="mb-4 rounded-xl border border-slate-200 bg-slate-50 p-3">
            <p className="text-xs font-bold text-[#336fea]">{activeNotice.id}</p>
